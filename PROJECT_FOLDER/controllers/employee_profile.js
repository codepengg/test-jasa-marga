...
async function findAllEmployeeProfile(req, res) {
...
async function findEmployeeProfile(req, res) {
...
async function insertEmployeeProfile(req, res) {
...
module.exports = {
    findAllEmployeeProfile, findEmployeeProfile, insertEmployeeProfile, updateEmployeeProfile, deleteEmployeeProfile
}