...
async function findAllEmployeeFamily(req, res) {
...
async function findEmployeeFamily(req, res) {
...
async function insertEmployeeFamily(req, res) {
...
async function updateEmployeeFamily(req, res) {
...
async function deleteEmployeeFamily(req, res) {
    const id = req.params.id;
    db.sequelize.transaction(async (t) => {
        const family = await EmployeeFamily.findByPk(id, {
            transaction: t
...
module.exports = {
    findAllEmployeeFamily, findEmployeeFamily, insertEmployeeFamily, updateEmployeeFamily, deleteEmployeeFamily
}