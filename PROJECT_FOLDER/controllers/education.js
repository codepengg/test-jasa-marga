...
async function findAllEmployeeEducation(req, res) {
    EmployeeEducation.findAll({
        include: [
            {
                model: Employee,
                as: 'employee',
                attributes: ['id', 'nik', 'name', 'startDate', 'endDate', 'isActive'],
            },
        ]
    }).then((education) => {
        if (education) {
...
async function findEmployeeEducation(req, res) {
...
async function insertEmployeeEducation(req, res) {
...
async function updateEmployeeEducation(req, res) {
...
async function deleteEmployeeEducation(req, res) {
    const id = req.params.id;
    db.sequelize.transaction(async (t) => {
        const education = await EmployeeEducation.findByPk(id, {
            transaction: t
...
module.exports = {
    findAllEmployeeEducation, findEmployeeEducation, insertEmployeeEducation, updateEmployeeEducation, deleteEmployeeEducation
}